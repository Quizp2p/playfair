...
{{
var G__11669 = cljs.core.pop.call(null,v__$1);
v__$1 = G__11669;
continue;
}
} else
...
{var pred__11673 = cljs.core._EQ_;var expr__11674 = limit;if(cljs.core.truth_(pred__11673.call(null,1,expr__11674)))
{return (new cljs.core.PersistentVector(null,1,5,cljs.core.PersistentVector.EMPTY_NODE,[s],null));
} else
{if(cljs.core.truth_(pred__11673.call(null,2,expr__11674)))
...
var G__11676 = s__$1.substring((index + cljs.core.count.call(null,m)));
var G__11677 = (limit__$1 - 1);
var G__11678 = cljs.core.conj.call(null,parts,s__$1.substring(0,index));
s__$1 = G__11676;
limit__$1 = G__11677;
parts = G__11678;
continue;
...
{var ch = s.charAt(index);var temp__4090__auto___11680 = cljs.core.get.call(null,cmap,ch);if(cljs.core.truth_(temp__4090__auto___11680))
{var replacement_11681 = temp__4090__auto___11680;buffer.append([cljs.core.str(replacement_11681)].join(''));
} else
{buffer.append(ch);
}
{
var G__11682 = (index + 1);
index = G__11682;
continue;
}
}

...
if(typeof playfair_cljs.core.t9842 !== 'undefined')
{} else
{
/**
* @constructor
*/
playfair_cljs.core.t9842 = (function (owner,app_state,render_app,meta9843){
this.owner = owner;
...
playfair_cljs.core.t9842.cljs$lang$type = true;
playfair_cljs.core.t9842.cljs$lang$ctorStr = "playfair-cljs.core/t9842";
playfair_cljs.core.t9842.cljs$lang$ctorPrWriter = (function (this__4008__auto__,writer__4009__auto__,opt__4010__auto__){return cljs.core._write.call(null,writer__4009__auto__,"playfair-cljs.core/t9842");
});
playfair_cljs.core.t9842.prototype.om$core$IRender$ = true;
playfair_cljs.core.t9842.prototype.om$core$IRender$render$arity$1 = (function (this$){var self__ = this;
var this$__$1 = this;var steps = playfair_cljs.asCompiler.app_state_to_steps.call(null,self__.app_state);return React.DOM.div({"className": "proper-height"},React.DOM.div({"className": "container"},React.DOM.svg({"height": (playfair_cljs.shapeData.canvas_size.call(null,1) / 6), "width": (playfair_cljs.shapeData.canvas_size.call(null,0) / 6)}),React.DOM.button({"id": "screenButton"},"+")),React.DOM.div({"className": "container-around"},React.DOM.div({"className": "left-panel"},React.DOM.p({"className": "center"},"Steps"),cljs.core.apply.call(null,om.dom.div,{"className": "steps"},om.core.build_all.call(null,playfair_cljs.components.step.render_step,steps))),React.DOM.div(null,React.DOM.div({"id": "mainCanvas"},om.core.build.call(null,playfair_cljs.components.scrubbable.make_scrub,self__.app_state),(function (){var last_state = playfair_cljs.asCompiler.get_last_state.call(null,cljs.core.last.call(null,steps));var second_last_state = playfair_cljs.asCompiler.get_last_state.call(null,cljs.core.last.call(null,playfair_cljs.general.safe_pop.call(null,steps)));return cljs.core.apply.call(null,om.dom.svg,{"id": "bigCanvas", "height": playfair_cljs.shapeData.canvas_size.call(null,1), "width": playfair_cljs.shapeData.canvas_size.call(null,0), "onMouseUp": (function (p1__9838_SHARP_){return cljs.core.async.put_BANG_.call(null,playfair_cljs.channels.canvas_chan,new cljs.core.PersistentArrayMap(null, 4, [new cljs.core.Keyword(null,"e-type","e-type",3950582548),new cljs.core.Keyword(null,"mouseUp","mouseUp",2256971154),new cljs.core.Keyword(null,"e","e",1013904343),p1__9838_SHARP_.nativeEvent,new cljs.core.Keyword(null,"reciever","reciever",4503726569),new cljs.core.Keyword(null,"canvas","canvas",3941165258),new cljs.core.Keyword(null,"second-last-state","second-last-state",4343999749),second_last_state], null));
}), "onMouseDown": (function (p1__9837_SHARP_){return cljs.core.async.put_BANG_.call(null,playfair_cljs.channels.canvas_chan,new cljs.core.PersistentArrayMap(null, 4, [new cljs.core.Keyword(null,"e-type","e-type",3950582548),new cljs.core.Keyword(null,"mouseDown","mouseDown",1599794777),new cljs.core.Keyword(null,"e","e",1013904343),p1__9837_SHARP_.nativeEvent,new cljs.core.Keyword(null,"reciever","reciever",4503726569),new cljs.core.Keyword(null,"canvas","canvas",3941165258),new cljs.core.Keyword(null,"second-last-state","second-last-state",4343999749),second_last_state], null));
}), "onMouseMove": (function (p1__9836_SHARP_){return cljs.core.async.put_BANG_.call(null,playfair_cljs.channels.canvas_chan,new cljs.core.PersistentArrayMap(null, 4, [new cljs.core.Keyword(null,"e-type","e-type",3950582548),new cljs.core.Keyword(null,"mouseMove","mouseMove",1600062856),new cljs.core.Keyword(null,"e","e",1013904343),p1__9836_SHARP_.nativeEvent,new cljs.core.Keyword(null,"reciever","reciever",4503726569),new cljs.core.Keyword(null,"canvas","canvas",3941165258),new cljs.core.Keyword(null,"second-last-state","second-last-state",4343999749),second_last_state], null));
...
playfair_cljs.core.t9842.prototype.cljs$core$IMeta$_meta$arity$1 = (function (_9844){var self__ = this;
var _9844__$1 = this;return self__.meta9843;
});
playfair_cljs.core.t9842.prototype.cljs$core$IWithMeta$_with_meta$arity$2 = (function (_9844,meta9843__$1){var self__ = this;
var _9844__$1 = this;return (new playfair_cljs.core.t9842(self__.owner,self__.app_state,self__.render_app,meta9843__$1));
});
playfair_cljs.core.__GT_t9842 = (function __GT_t9842(owner__$1,app_state__$1,render_app__$1,meta9843){return (new playfair_cljs.core.t9842(owner__$1,app_state__$1,render_app__$1,meta9843));
});
}
return (new playfair_cljs.core.t9842(owner,app_state,render_app,null));
});
...
goog.events.listen(document,"mousemove",(function (p1__9845_SHARP_){return cljs.core.async.put_BANG_.call(null,playfair_cljs.channels.global_chan,new cljs.core.PersistentArrayMap(null, 2, [new cljs.core.Keyword(null,"e-type","e-type",3950582548),new cljs.core.Keyword(null,"mouseMove","mouseMove",1600062856),new cljs.core.Keyword(null,"e","e",1013904343),p1__9845_SHARP_], null));
}));
goog.events.listen(document,"mouseup",(function (p1__9846_SHARP_){return cljs.core.async.put_BANG_.call(null,playfair_cljs.channels.global_chan,new cljs.core.PersistentArrayMap(null, 2, [new cljs.core.Keyword(null,"e-type","e-type",3950582548),new cljs.core.Keyword(null,"mouseUp","mouseUp",2256971154),new cljs.core.Keyword(null,"e","e",1013904343),p1__9846_SHARP_], null));
}));

...
cljs.core.async.impl.dispatch.queued_QMARK_ = false;
var count_11971 = 0;while(true){
var m_11972 = cljs.core.async.impl.dispatch.tasks.pop();if((m_11972 == null))
{} else
{m_11972.call(null);
if((count_11971 < cljs.core.async.impl.dispatch.TASK_BATCH_SIZE))
{{
var G__11973 = (count_11971 + 1);
count_11971 = G__11973;
continue;
}
} else
{}

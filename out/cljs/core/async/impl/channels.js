...
goog.require('cljs.core.async.impl.protocols');
cljs.core.async.impl.channels.box = (function box(val){if(typeof cljs.core.async.impl.channels.t11977 !== 'undefined')
{} else
{
/**
* @constructor
*/
cljs.core.async.impl.channels.t11977 = (function (val,box,meta11978){
this.val = val;
this.box = box;
...
cljs.core.async.impl.channels.t11977.cljs$lang$type = true;
cljs.core.async.impl.channels.t11977.cljs$lang$ctorStr = "cljs.core.async.impl.channels/t11977";
cljs.core.async.impl.channels.t11977.cljs$lang$ctorPrWriter = (function (this__4008__auto__,writer__4009__auto__,opt__4010__auto__){return cljs.core._write.call(null,writer__4009__auto__,"cljs.core.async.impl.channels/t11977");
});
cljs.core.async.impl.channels.t11977.prototype.cljs$core$IDeref$_deref$arity$1 = (function (_){var self__ = this;
var ___$1 = this;return self__.val;
});
cljs.core.async.impl.channels.t11977.prototype.cljs$core$IMeta$_meta$arity$1 = (function (_11979){var self__ = this;
var _11979__$1 = this;return self__.meta11978;
});
cljs.core.async.impl.channels.t11977.prototype.cljs$core$IWithMeta$_with_meta$arity$2 = (function (_11979,meta11978__$1){var self__ = this;
var _11979__$1 = this;return (new cljs.core.async.impl.channels.t11977(self__.val,self__.box,meta11978__$1));
});
cljs.core.async.impl.channels.__GT_t11977 = (function __GT_t11977(val__$1,box__$1,meta11978){return (new cljs.core.async.impl.channels.t11977(val__$1,box__$1,meta11978));
});
}
return (new cljs.core.async.impl.channels.t11977(val,box,null));
});
...
cljs.core.async.impl.channels.PutBox.cljs$lang$ctorPrWriter = (function (this__4011__auto__,writer__4012__auto__,opts__4013__auto__){return cljs.core._write.call(null,writer__4012__auto__,"cljs.core.async.impl.channels/PutBox");
});
...
cljs.core.async.impl.channels.ManyToManyChannel.cljs$lang$ctorPrWriter = (function (this__4008__auto__,writer__4009__auto__,opt__4010__auto__){return cljs.core._write.call(null,writer__4009__auto__,"cljs.core.async.impl.channels/ManyToManyChannel");
});
...
{self__.closed = true;
while(true){
var taker_11980 = self__.takes.pop();if((taker_11980 == null))
{} else
{if(cljs.core.async.impl.protocols.active_QMARK_.call(null,taker_11980))
{var take_cb_11981 = cljs.core.async.impl.protocols.commit.call(null,taker_11980);cljs.core.async.impl.dispatch.run.call(null,((function (take_cb_11981,taker_11980){
return (function (){return take_cb_11981.call(null,null);
});})(take_cb_11981,taker_11980))
);
} else
{}
{
